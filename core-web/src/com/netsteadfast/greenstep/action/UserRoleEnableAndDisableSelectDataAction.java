...
/**
 * 主要是提供使用者角色設定頁面 multiselect 資料的來源
 *
 */
@ControllerAuthority(check=true)
@Controller("core.web.controller.UserRoleEnableAndDisableSelectDataAction")
@Scope
public class UserRoleEnableAndDisableSelectDataAction extends BaseJsonAction {
	private static final long serialVersionUID = 5745108444858836524L;
	protected Logger logger=Logger.getLogger(UserRoleEnableAndDisableSelectDataAction.class);
	...
	public UserRoleEnableAndDisableSelectDataAction() {
		super();
	}
