...
@Controller("core.web.controller.SystemFormTemplateManagementGridQueryAction")
@Scope
public class SystemFormTemplateManagementGridQueryAction extends BaseQueryGridJsonAction {
	private static final long serialVersionUID = -7196477175848287558L;
	protected Logger logger=Logger.getLogger(SystemFormTemplateManagementGridQueryAction.class);
	private ISysFormTemplateService<SysFormTemplateVO, TbSysFormTemplate, String> sysFormTemplateService;
	private String message = "";
	private String success = IS_NO;
	private List<Map<String, String>> items=new ArrayList<Map<String, String>>();
	
	public SystemFormTemplateManagementGridQueryAction() {
		super();
	}
	...
	private void query() throws ControllerException, AuthorityException, ServiceException, Exception {
		QueryResult<List<SysFormTemplateVO>> queryResult = this.sysFormTemplateService.findGridResult(
	...
	private void setGridData(List<SysFormTemplateVO> searchList) throws Exception {		
		if (searchList==null || searchList.size()<1) {
			return;
		}
		this.items = super.transformSearchGridList2JsonDataMapList(
				searchList, 
				new String[]{"oid", "tplId", "name", "fileName", "description"});		
	}		
	
	/**
	 * core.systemFormTemplateManagementGridQueryAction.action
	 */
