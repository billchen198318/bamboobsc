...
@Controller("core.web.controller.RoleManagementGridQueryAction")
@Scope
public class RoleManagementGridQueryAction extends BaseQueryGridJsonAction {
	private static final long serialVersionUID = 378733608829948636L;
	protected Logger logger=Logger.getLogger(RoleManagementGridQueryAction.class);
	private IRoleService<RoleVO, TbRole, String> roleService;
	private String message = "";
	private String success = IS_NO;
	private List<Map<String, String>> items=new ArrayList<Map<String, String>>();
	
	public RoleManagementGridQueryAction() {
		super();
	}
	...
	private void query() throws ControllerException, AuthorityException, ServiceException, Exception {
		QueryResult<List<RoleVO>> queryResult = this.roleService.findGridResult(
	...
	private void setGridData(List<RoleVO> searchList) throws Exception {
		if (searchList==null || searchList.size()<1) {
			return;
		}
		this.items = super.transformSearchGridList2JsonDataMapList(
				searchList, new String[]{"oid", "role", "description"});			
	}
	
	/**
	 * core.roleManagementGridQueryAction.action
	 */	
