...
@Controller("core.web.controller.SystemContextBeanManagmentGridQueryAction")
@Scope
public class SystemContextBeanManagmentGridQueryAction extends BaseQueryGridJsonAction {
	private static final long serialVersionUID = 9003831798951189149L;
	protected Logger logger=Logger.getLogger(SystemContextBeanManagmentGridQueryAction.class);
	private ISysCtxBeanService<SysCtxBeanVO, TbSysCtxBean, String> sysCtxBeanService;
	private String message = "";
	private String success = IS_NO;
	private List<Map<String, String>> items=new ArrayList<Map<String, String>>();
	
	public SystemContextBeanManagmentGridQueryAction() {
		super();
	}
	...
	private void query() throws ControllerException, AuthorityException, ServiceException, Exception {
		QueryResult<List<SysCtxBeanVO>> queryResult = this.sysCtxBeanService.findGridResult(
	...
	private void setGridData(List<SysCtxBeanVO> searchList) throws Exception {		
		if (searchList==null || searchList.size()<1) {
			return;
		}		
		this.items = super.transformSearchGridList2JsonDataMapList(
				searchList, 
				new String[]{"oid", "system", "className", "type", "description"});		
	}	
	
	/**
	 * core.systemContextBeanManagementGridQueryAction.action
	 */
