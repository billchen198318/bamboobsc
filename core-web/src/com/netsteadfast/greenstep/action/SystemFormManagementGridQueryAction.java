...
@Controller("core.web.controller.SystemFormManagementGridQueryAction")
@Scope
public class SystemFormManagementGridQueryAction extends BaseQueryGridJsonAction {
	private static final long serialVersionUID = 1186494162256364447L;
	protected Logger logger=Logger.getLogger(SystemFormManagementGridQueryAction.class);
	private ISysFormService<SysFormVO, TbSysForm, String> sysFormService;
	private String message = "";
	private String success = IS_NO;
	private List<Map<String, String>> items=new ArrayList<Map<String, String>>();
	
	public SystemFormManagementGridQueryAction() {
		super();
	}
	...
	private void query() throws ControllerException, AuthorityException, ServiceException, Exception {
		QueryResult<List<SysFormVO>> queryResult = this.sysFormService.findGridResult(
	...
	private void setGridData(List<SysFormVO> searchList) throws Exception {		
		if (searchList==null || searchList.size()<1) {
			return;
		}		
		this.items = super.transformSearchGridList2JsonDataMapList(
				searchList, 
				new String[]{"oid", "formId", "templateId", "name", "description"});		
	}	
	
	/**
	 * core.systemFormManagementGridQueryAction.action
	 */
