...
@Controller("core.web.controller.SystemMessageNoticeManagementGridQueryAction")
@Scope
public class SystemMessageNoticeManagementGridQueryAction extends BaseQueryGridJsonAction {
	private static final long serialVersionUID = -1406015532134585532L;
	protected Logger logger=Logger.getLogger(SystemMessageNoticeManagementGridQueryAction.class);
	private ISysMsgNoticeService<SysMsgNoticeVO, TbSysMsgNotice, String> sysMsgNoticeService;
	private String message = "";
	private String success = IS_NO;
	private List<Map<String, String>> items=new ArrayList<Map<String, String>>();
	
	public SystemMessageNoticeManagementGridQueryAction() {
		super();
	}
	...
	private void query() throws ControllerException, AuthorityException, ServiceException, Exception {
		QueryResult<List<SysMsgNoticeVO>> queryResult = this.sysMsgNoticeService.findGridResult(
	...
	private void setGridData(List<SysMsgNoticeVO> searchList) throws Exception {
		if (searchList==null || searchList.size()<1) {
			return;
		}
		this.items = super.transformSearchGridList2JsonDataMapList(
				searchList, 
				new String[]{"oid", "noticeId", "msgId", "title", "date", "time", "isGlobal", "toAccount"});
	}	
	
	/**
	 * core.systemMessageNoticeManagementGridQueryAction.action
	 */
