...
@Controller("core.web.controller.SystemFormMethodManagementGridQueryAction")
@Scope
public class SystemFormMethodManagementGridQueryAction extends BaseQueryGridJsonAction {
	private static final long serialVersionUID = 8235407895184095021L;
	protected Logger logger=Logger.getLogger(SystemFormMethodManagementGridQueryAction.class);
	private ISysFormMethodService<SysFormMethodVO, TbSysFormMethod, String> sysFormMethodService;
	private String message = "";
	private String success = IS_NO;
	private List<Map<String, String>> items=new ArrayList<Map<String, String>>();
	
	public SystemFormMethodManagementGridQueryAction() {
		super();
	}
	...
	private void query() throws ControllerException, AuthorityException, ServiceException, Exception {
		QueryResult<List<SysFormMethodVO>> queryResult = this.sysFormMethodService.findGridResult(
	...
	private void setGridData(List<SysFormMethodVO> searchList) throws Exception {		
		if (searchList==null || searchList.size()<1) {
			return;
		}		
		this.items = super.transformSearchGridList2JsonDataMapList(
				searchList, 
				new String[]{"oid", "formId", "name", "resultType", "type", "description"});		
	}	
	
	/**
	 * core.systemFormMethodManagementGridQueryAction.action
	 */
