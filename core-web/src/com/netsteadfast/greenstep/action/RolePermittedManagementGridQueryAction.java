...
@Controller("core.web.controller.RolePermittedManagementGridQueryAction")
@Scope
public class RolePermittedManagementGridQueryAction extends BaseQueryGridJsonAction {
	private static final long serialVersionUID = 2823506887564496612L;
	protected Logger logger=Logger.getLogger(RolePermittedManagementGridQueryAction.class);
	private IRolePermissionService<RolePermissionVO, TbRolePermission, String> rolePermissionService; 
	private String message = "";
	private String success = IS_NO;
	private List<Map<String, String>> items=new ArrayList<Map<String, String>>();
	
	public RolePermittedManagementGridQueryAction() {
		super();
	}		
	...
	private void query() throws ControllerException, AuthorityException, ServiceException, Exception {
		QueryResult<List<RolePermissionVO>> queryResult = this.rolePermissionService.findGridResult(
	...
	private void setGridData(List<RolePermissionVO> searchList) throws Exception {
		if (searchList==null || searchList.size()<1) {
			return;
		}
		this.items = super.transformSearchGridList2JsonDataMapList(
				searchList, new String[]{"oid", "permission", "permType", "description"});			
	}
	
	/**
	 * core.rolePermittedManagementGridQueryAction.action
	 */	
