	...
	<table border="0" width="100%" height="275px" cellpadding="1" cellspacing="0" >	
		<tr>
    		<td height="50px" width="100%"  align="left">
    			<gs:label text="${action.getText('CORE_PROG003D0002A_exprId')}" id="CORE_PROG003D0002A_exprId" requiredFlag="Y"></gs:label>
    			<gs:inputfieldNoticeMsgLabel id="CORE_PROG003D0002A_exprId"></gs:inputfieldNoticeMsgLabel>
    			<br/>
		...
		<tr>
    		<td height="50px" width="20%"  align="left">
    			<gs:label text="${action.getText('CORE_PROG003D0002A_type')}" id="CORE_PROG003D0002A_type" requiredFlag="Y"></gs:label>
    			<gs:inputfieldNoticeMsgLabel id="CORE_PROG003D0002A_type"></gs:inputfieldNoticeMsgLabel>
    			<br/>
		...
		<tr>
    		<td height="50px" width="100%"  align="left">
    			<gs:label text="${action.getText('CORE_PROG003D0002A_name')}" id="CORE_PROG003D0002A_name" requiredFlag="Y"></gs:label>
    			<gs:inputfieldNoticeMsgLabel id="CORE_PROG003D0002A_name"></gs:inputfieldNoticeMsgLabel>
    			<br/>
		...
		<tr>
    		<td height="125px" width="100%"  align="left">
    			<gs:label text="${action.getText('CORE_PROG003D0002A_description')}" id="CORE_PROG003D0002A_description"></gs:label>
    			<br/>
