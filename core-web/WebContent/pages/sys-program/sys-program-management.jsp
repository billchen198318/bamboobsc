...
function CORE_PROG001D0002Q_GridFieldStructure() {
	return [
			{ name: "View&nbsp;/&nbsp;Edit", field: "oid", formatter: CORE_PROG001D0002Q_GridButtonClick, width: "10%" },  
			{ name: "Progeam Id", field: "progId", width: "15%" },
			{ name: "Name", field: "name", width: "20%" },
			{ name: "URL", field: "url", width: "35%" },
			{ name: "System", field: "progSystem", width: "10%" },
			{ name: "Type", field: "itemType", width: "10%" }
		];	
}
