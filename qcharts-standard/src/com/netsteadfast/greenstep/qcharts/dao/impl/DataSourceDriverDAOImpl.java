...
@Repository("qcharts.dao.DataSourceDriverDAO")
@Scope("prototype")
public class DataSourceDriverDAOImpl extends BaseDAO<QcDataSourceDriver, String> implements IDataSourceDriverDAO<QcDataSourceDriver, String> {
	
	public DataSourceDriverDAOImpl() {
		super();
	}
