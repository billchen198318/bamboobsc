...
@Repository("qcharts.dao.DataQueryMapperSetDAO")
@Scope("prototype")
public class DataQueryMapperSetDAOImpl extends BaseDAO<QcDataQueryMapperSet, String> implements IDataQueryMapperSetDAO<QcDataQueryMapperSet, String> {
	
	public DataQueryMapperSetDAOImpl() {
		super();
	}
