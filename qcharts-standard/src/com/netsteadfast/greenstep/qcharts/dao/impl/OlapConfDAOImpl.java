...
@Repository("qcharts.dao.OlapConfDAO")
@Scope("prototype")
public class OlapConfDAOImpl extends BaseDAO<QcOlapConf, String> implements IOlapConfDAO<QcOlapConf, String> {
	
	public OlapConfDAOImpl() {
		super();
	}
