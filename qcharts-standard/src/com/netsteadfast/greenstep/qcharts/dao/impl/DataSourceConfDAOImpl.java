...
@Repository("qcharts.dao.DataSourceConfDAO")
@Scope("prototype")
public class DataSourceConfDAOImpl extends BaseDAO<QcDataSourceConf, String> implements IDataSourceConfDAO<QcDataSourceConf, String> {
	
	public DataSourceConfDAOImpl() {
		super();
	}
