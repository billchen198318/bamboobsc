...
@Repository("qcharts.dao.DataQueryMapperDAO")
@Scope("prototype")
public class DataQueryMapperDAOImpl extends BaseDAO<QcDataQueryMapper, String> implements IDataQueryMapperDAO<QcDataQueryMapper, String> {
	
	public DataQueryMapperDAOImpl() {
		super();
	}
