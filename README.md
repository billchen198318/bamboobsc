...
https://github.com/billchen198318/bamboobsc/releases/download/v0.7.6/bamboobsc-0.7.6-RELEASE.7z
<br/><br/>
...
```
# cd /home
# wget --no-check-certificate https://github.com/billchen198318/bamboobsc/releases/download/v0.7.6/bamboobsc-0.7.6-RELEASE.7z
```
...
```
# p7zip -d bamboobsc-0.7.6-RELEASE.7z
```
