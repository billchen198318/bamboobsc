						...
						<table border="0" width="100%" >
							...
							<tr valign="top">
								<td width="100%" align="left" height="25px">							
									...
									<gs:filteringSelect name="BSC_PROG003D0006Q_measureDataOrganizationOid" dataSource="measureDataOrganizationMap" id="BSC_PROG003D0006Q_measureDataOrganizationOid" onChange="BSC_PROG003D0006Q_setMeasureDataOrgaValue();" readonly="Y"></gs:filteringSelect>
									...
									<gs:filteringSelect name="BSC_PROG003D0006Q_measureDataEmployeeOid" dataSource="measureDataEmployeeMap" id="BSC_PROG003D0006Q_measureDataEmployeeOid" onChange="BSC_PROG003D0006Q_setMeasureDataEmplValue();" readonly="Y"></gs:filteringSelect>
