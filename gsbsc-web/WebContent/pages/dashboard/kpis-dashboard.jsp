...
function BSC_PROG003D0006Q_query() {
	...
	xhrSendParameter(
			'${basePath}/bsc.kpisDashboardContentAction.action', 
			{ 
			...
			function(data) {
				...
				dijit.byId("BSC_PROG003D0006Q_startDate").set("displayedValue", data.startDate);
				dijit.byId("BSC_PROG003D0006Q_endDate").set("displayedValue", data.endDate);
...
function BSC_PROG003D0006Q_generateExport() {
	
	var gaugeDatas = [];
	var dateRangeChartPngData = null;
	if ( '' != $('#BSC_PROG003D0006Q_kpis_daterange_container').html() ) {
		var dateRangeSvg = $('#BSC_PROG003D0006Q_kpis_daterange_container').highcharts().getSVG();
		dateRangeChartPngData = viewPage.getSVGImage2CanvasToDataUrlPNGfromData( dateRangeSvg );
	}
	dojo.query("div").forEach(function(node){
		if (node.id!=null && node.id.indexOf('BSC_PROG003D0006Q_kpis_container_')>-1) {
...
function BSC_PROG003D0006Q_showTableContent( data ) {
	...
	t += '</tr>';	
	t += '</table>';
	dojo.byId("BSC_PROG003D0006Q_content").innerHTML = t;
}
...
function BSC_PROG003D0006Q_showChartForKpis(data) {
	...
	$("#BSC_PROG003D0006Q_kpis_container").html( chartDivContent );
    	...
    	for (var o in perspective.objectives) {
			...
			for (var k in objective.kpis) {
	    	    ...
	    	    $( '#'+divChartId ).highcharts(Highcharts.merge(gaugeOptions, {
	    	        ...
	    	        series: [{
	    	            name: kpi.name,
	    	            data: [ parseFloat( BSC_PROG003D0006Q_parseScore(kpi.score) ) ],
	    	            dataLabels: {
...
function BSC_PROG003D0006Q_showChartForKpiDateRange(data) {
	
	if ( null == data.categories || data.categories.length < 2 ) {
		return;
	}
	
    $('#BSC_PROG003D0006Q_kpis_daterange_container').highcharts({
        title: {
...
function BSC_PROG003D0006Q_clearContent() {
	dojo.byId("BSC_PROG003D0006Q_content").innerHTML = "";
	dojo.byId("BSC_PROG003D0006Q_kpis_container").innerHTML = "";
	dojo.byId("BSC_PROG003D0006Q_kpis_daterange_container").innerHTML = "";
}
...
<body class="flat">
						...
						<table border="0" width="100%" >
							<tr valign="top">
								<td width="100%" align="left" height="25px" style="border:1px #ebeadb solid; border-radius: 5px; background: linear-gradient(to top, #f1eee5 , #fafafa);">	
									...
									<div data-dojo-type="dijit/Tooltip" data-dojo-props="connectId:'BSC_PROG003D0006Q_btnQuery'">
					    				<s:property value="getText('BSC_PROG003D0006Q_btnQuery')"/>
									</div>
																		
									<!-- ####################################################################################################### -->
									<!-- Current year -->		
									<button id="BSC_PROG003D0006Q_btnQueryForCurrentYear" data-dojo-type="dijit.form.Button"
										data-dojo-props="
											showLabel:true,
											onClick:function(){  
												dijit.byId('BSC_PROG003D0006Q_frequency').set('value', '6');
												setReportQueryDateFieldForCurrent('6', 'BSC_PROG003D0006Q_startYearDate', 'BSC_PROG003D0006Q_endYearDate');
												BSC_PROG003D0006Q_query();
											}"><b>Y</b></button>	
									<div data-dojo-type="dijit/Tooltip" data-dojo-props="connectId:'BSC_PROG003D0006Q_btnQueryForCurrentYear'">
					    				<s:property value="getText('BSC_PROG003D0006Q_btnQuery')"/> (Current year)
									</div>
																																	
									<!-- Current half-year -->		
									<button id="BSC_PROG003D0006Q_btnQueryForCurrentHalfYear" data-dojo-type="dijit.form.Button"
										data-dojo-props="
											showLabel:true,
											onClick:function(){  
												dijit.byId('BSC_PROG003D0006Q_frequency').set('value', '5');
												setReportQueryDateFieldForCurrent('5', 'BSC_PROG003D0006Q_startYearDate', 'BSC_PROG003D0006Q_endYearDate');
												BSC_PROG003D0006Q_query();
											}"><b>H</b></button>		
									<div data-dojo-type="dijit/Tooltip" data-dojo-props="connectId:'BSC_PROG003D0006Q_btnQueryForCurrentHalfYear'">
					    				<s:property value="getText('BSC_PROG003D0006Q_btnQuery')"/> (Half-year of the current year)
									</div>											
											
									<!-- Current quarterly -->		
									<button id="BSC_PROG003D0006Q_btnQueryForCurrentQuarter" data-dojo-type="dijit.form.Button"
										data-dojo-props="
											showLabel:true,
											onClick:function(){  
												dijit.byId('BSC_PROG003D0006Q_frequency').set('value', '4');
												setReportQueryDateFieldForCurrent('4', 'BSC_PROG003D0006Q_startYearDate', 'BSC_PROG003D0006Q_endYearDate');
												BSC_PROG003D0006Q_query();
											}"><b>Q</b></button>			
									<div data-dojo-type="dijit/Tooltip" data-dojo-props="connectId:'BSC_PROG003D0006Q_btnQueryForCurrentQuarter'">
					    				<s:property value="getText('BSC_PROG003D0006Q_btnQuery')"/> (Quarterly of the current year)
									</div>
																				
									<!-- Current month -->		
									<button id="BSC_PROG003D0006Q_btnQueryForCurrentMonth" data-dojo-type="dijit.form.Button"
										data-dojo-props="
											showLabel:true,
											onClick:function(){  
												dijit.byId('BSC_PROG003D0006Q_frequency').set('value', '3');
												setReportQueryDateFieldForCurrent('3', 'BSC_PROG003D0006Q_startDate', 'BSC_PROG003D0006Q_endDate');
												BSC_PROG003D0006Q_query();
											}"><b>M</b></button>		
									<div data-dojo-type="dijit/Tooltip" data-dojo-props="connectId:'BSC_PROG003D0006Q_btnQueryForCurrentMonth'">
					    				<s:property value="getText('BSC_PROG003D0006Q_btnQuery')"/> (Current month)
									</div>
									...
									<button id="BSC_PROG003D0006Q_btnXls" data-dojo-type="dijit.form.Button"
										data-dojo-props="
											...
											showLabel:false,
											onClick:function(){
												BSC_PROG003D0006Q_generateExport();																			  
											}"><s:property value="getText('BSC_PROG003D0006Q_btnXls')"/></button>	
									<div data-dojo-type="dijit/Tooltip" data-dojo-props="connectId:'BSC_PROG003D0006Q_btnXls'">
					    				<s:property value="getText('BSC_PROG003D0006Q_btnXls')"/>
									</div>											
							...
							<tr valign="top">
								<td width="100%" align="left" height="25px">	
									...
									<gs:select name="BSC_PROG003D0006Q_frequency" dataSource="frequencyMap" id="BSC_PROG003D0006Q_frequency" value="6" onChange="BSC_PROG003D0006Q_setFrequencyValue();" width="140"></gs:select>
	...
	<div id="BSC_PROG003D0006Q_content"></div>	
	
	<br>
	
	<div id="BSC_PROG003D0006Q_kpis_container"></div>
	
	<br>
	
	<div id="BSC_PROG003D0006Q_kpis_daterange_container"  style="width: 100%; height: 450px; float: left"></div>
