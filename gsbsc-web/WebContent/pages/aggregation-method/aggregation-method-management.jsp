...
function BSC_PROG001D0008Q_GridFieldStructure() {
	return [
			{ name: "View&nbsp;/&nbsp;Edit", field: "oid", formatter: BSC_PROG001D0008Q_GridButtonClick, width: "15%" },  
			{ name: "Id", field: "aggrId", width: "15%" },
...
<body class="claro" bgcolor="#EEEEEE" >
	...
	<table border="0" width="100%" height="50px" cellpadding="1" cellspacing="0" >		
		<tr>
    		...
    		<td height="25px" width="40%"  align="left"><gs:textBox name="BSC_PROG001D0008Q_aggrId" id="BSC_PROG001D0008Q_aggrId" value="" width="200" maxlength="14"></gs:textBox></td>  					
    		<td height="25px" width="10%"  align="right">Name:</td>
    		<td height="25px" width="40%"  align="left"><gs:textBox name="BSC_PROG001D0008Q_name" id="BSC_PROG001D0008Q_name" value="" width="200" maxlength="100"></gs:textBox></td>  					
    	</tr>
    	<tr>
