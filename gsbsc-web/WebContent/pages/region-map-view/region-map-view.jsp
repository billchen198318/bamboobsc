...
function BSC_PROG001D0006Q_showOrganizationInfo(organization) {
	...
	var content = '';
	content += '<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#c1c7d0" >';
	content += '<tr>';
	content += '<td colspan="2" bgcolor="DFFAFF" align="center" ><b>Organization</b></td>';
	content += '</tr>';	
	content += '<tr>';
	...
	if (organization.address!=null && ""!=organization.address) {
		content += '<tr>';
		content += '<td bgcolor="#F2F2F2" align="right" >Address</td>';
	...
	if (organization.description!=null && ""!=organization.description) {
		content += '<tr>';
		content += '<td bgcolor="#F2F2F2" align="right" >Description</td>';
...
function BSC_PROG001D0006Q_showRelationKpis(kpis) {
	...
	content += '<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#c1c7d0" >';
	content += '<tr>';
	content += '<td colspan="2" bgcolor="DFFAFF" align="center" ><b>KPIs</b></td>';
	content += '</tr>';	
