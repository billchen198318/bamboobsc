								...
								<div dojoType="dijit.layout.ContentPane" region="left" splitter="false" style="width:99%;height:140px">
									...
									<table border="0" width="100%" >
										...
										<tr valign="top">
											<td width="100%" align="left" height="25px">							
												Data type
												<gs:select name="BSC_PROG007D0001A_measureFreq_dataFor" dataSource="{ \"all\":\"All\", \"organization\":\"Organization\", \"employee\":\"Employee\" }" id="BSC_PROG007D0001A_measureFreq_dataFor" onChange="BSC_PROG007D0001A_measureFreq_setDataForValue();" width="140"></gs:select>
