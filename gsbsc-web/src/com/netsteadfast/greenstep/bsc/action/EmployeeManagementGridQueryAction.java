...
@Controller("bsc.web.controller.EmployeeManagementGridQueryAction")
@Scope
public class EmployeeManagementGridQueryAction extends BaseQueryGridJsonAction {
	private static final long serialVersionUID = -5500846994836430772L;
	protected Logger logger=Logger.getLogger(EmployeeManagementGridQueryAction.class);
	private IEmployeeService<EmployeeVO, BbEmployee, String> employeeService;
	private String message = "";
	private String success = IS_NO;
	private List<Map<String, String>> items=new ArrayList<Map<String, String>>();
	
	public EmployeeManagementGridQueryAction() {
		super();
	}
	...
	private void query() throws ControllerException, AuthorityException, ServiceException, Exception {
		QueryResult<List<EmployeeVO>> queryResult = this.employeeService.findGridResult(
	...
	private void setGridData(List<EmployeeVO> searchList) throws Exception {		
		if (searchList==null || searchList.size()<1) {
			return;
		}		
		this.items = super.transformSearchGridList2JsonDataMapList(
				searchList, new String[]{"oid", "account", "empId", "fullName", "jobTitle"});		
	}	
	
	/**
	 * bsc.employeeManagementGridQueryAction.action
	 */
