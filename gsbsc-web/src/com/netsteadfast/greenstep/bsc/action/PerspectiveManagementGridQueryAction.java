...
@Controller("bsc.web.controller.PerspectiveManagementGridQueryAction")
@Scope
public class PerspectiveManagementGridQueryAction extends BaseQueryGridJsonAction {
	private static final long serialVersionUID = -174311486500149100L;
	protected Logger logger=Logger.getLogger(PerspectiveManagementGridQueryAction.class);
	private IPerspectiveService<PerspectiveVO, BbPerspective, String> perspectiveService;
	private String message = "";
	private String success = IS_NO;
	private List<Map<String, String>> items=new ArrayList<Map<String, String>>();
	
	public PerspectiveManagementGridQueryAction() {
		super();
	}
	...
	private void query() throws ControllerException, AuthorityException, ServiceException, Exception {
		QueryResult<List<PerspectiveVO>> queryResult = this.perspectiveService.findGridResult(
	...
	private void setGridData(List<PerspectiveVO> searchList) throws Exception {		
		if (searchList==null || searchList.size()<1) {
			return;
		}		
		this.items = super.transformSearchGridList2JsonDataMapList(
				searchList, new String[]{"oid", "perId", "visId", "name", "weight", "visionTitle"});		
	}	
	
	/**
	 * bsc.visionManagementGridQueryAction.action
	 */
