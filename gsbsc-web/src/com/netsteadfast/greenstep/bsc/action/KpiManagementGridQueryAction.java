...
@Controller("bsc.web.controller.KpiManagementGridQueryAction")
@Scope
public class KpiManagementGridQueryAction extends BaseQueryGridJsonAction {
	private static final long serialVersionUID = 2972896793150804788L;
	protected Logger logger=Logger.getLogger(KpiManagementGridQueryAction.class);
	private IKpiService<KpiVO, BbKpi, String> kpiService; 
	private String message = "";
	private String success = IS_NO;
	private List<Map<String, String>> items=new ArrayList<Map<String, String>>();
	
	public KpiManagementGridQueryAction() {
		super();
	}
	...
	private void query() throws ControllerException, AuthorityException, ServiceException, Exception {
		QueryResult<List<KpiVO>> queryResult = this.kpiService.findGridResult(
	...
	private void setGridData(List<KpiVO> searchList) throws Exception {		
		if (searchList==null || searchList.size()<1) {
			return;
		}				
		this.items = super.transformSearchGridList2JsonDataMapList(
				searchList, new String[]{"oid", "id", "name", "weight", "description", 
						"visionTitle", "perspectiveName", "objectiveName"});		
	}	
	
	/**
	 * bsc.kpiManagementGridQueryAction.action
	 */
