...
@Controller("bsc.web.controller.TsaManagementGridQueryAction")
@Scope
public class TsaManagementGridQueryAction extends BaseQueryGridJsonAction {
	private static final long serialVersionUID = -7990614965007125738L;
	protected Logger logger = Logger.getLogger(TsaManagementGridQueryAction.class);
	private ITsaService<TsaVO, BbTsa, String> tsaService;
	private String message = "";
	private String success = IS_NO;
	private List<Map<String, String>> items = new ArrayList<Map<String, String>>();	
	
	public TsaManagementGridQueryAction() {
		super();
	}
	...
	private void query() throws ControllerException, AuthorityException, ServiceException, Exception {
		QueryResult<List<TsaVO>> queryResult = this.tsaService.findGridResult(super.getSearchValue(), super.getPageOf());
		this.success = IS_YES;
	...
	private void setGridData(List<TsaVO> searchList) throws Exception {
	...
	/**
	 * bsc.tsaManagementGridQueryAction.action
	 */
