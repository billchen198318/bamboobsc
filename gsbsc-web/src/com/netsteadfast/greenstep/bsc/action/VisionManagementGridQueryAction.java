...
@Controller("bsc.web.controller.VisionManagementGridQueryAction")
@Scope
public class VisionManagementGridQueryAction extends BaseQueryGridJsonAction {
	private static final long serialVersionUID = 2291496843795460154L;
	protected Logger logger=Logger.getLogger(VisionManagementGridQueryAction.class);
	private IVisionService<VisionVO, BbVision, String> visionService;
	private String message = "";
	private String success = IS_NO;
	private List<Map<String, String>> items=new ArrayList<Map<String, String>>();
	
	public VisionManagementGridQueryAction() {
		super();
	}
	...
	private void query() throws ControllerException, AuthorityException, ServiceException, Exception {
		QueryResult<List<VisionVO>> queryResult = this.visionService.findGridResult(
	...
	private void setGridData(List<VisionVO> searchList) throws Exception {		
		if (searchList==null || searchList.size()<1) {
			return;
		}		
		this.items = super.transformSearchGridList2JsonDataMapList(
				searchList, new String[]{"oid", "visId", "title"});		
	}	
