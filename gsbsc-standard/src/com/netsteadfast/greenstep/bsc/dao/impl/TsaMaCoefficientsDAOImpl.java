...
@Repository("bsc.dao.TsaMaCoefficientsDAO")
@Scope("prototype")
public class TsaMaCoefficientsDAOImpl extends BaseDAO<BbTsaMaCoefficients, String> implements ITsaMaCoefficientsDAO<BbTsaMaCoefficients, String> {
	
	public TsaMaCoefficientsDAOImpl() {
		super();
	}
