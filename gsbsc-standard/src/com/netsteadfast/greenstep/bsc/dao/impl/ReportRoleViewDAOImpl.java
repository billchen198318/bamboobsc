...
@Repository("bsc.dao.ReportRoleViewDAO")
@Scope("prototype")
public class ReportRoleViewDAOImpl extends BaseDAO<BbReportRoleView, String> implements IReportRoleViewDAO<BbReportRoleView, String> {
	
	public ReportRoleViewDAOImpl() {
		super();
	}
