...
@Repository("bsc.dao.DegreeFeedbackItemDAO")
@Scope("prototype")
public class DegreeFeedbackItemDAOImpl extends BaseDAO<BbDegreeFeedbackItem, String> implements IDegreeFeedbackItemDAO<BbDegreeFeedbackItem, String> {
	
	public DegreeFeedbackItemDAOImpl() {
		super();
	}
