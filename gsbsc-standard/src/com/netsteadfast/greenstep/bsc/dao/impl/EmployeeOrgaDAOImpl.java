...
@Repository("bsc.dao.EmployeeOrgaDAO")
@Scope("prototype")
public class EmployeeOrgaDAOImpl extends BaseDAO<BbEmployeeOrga, String> implements IEmployeeOrgaDAO<BbEmployeeOrga, String> {
	
	public EmployeeOrgaDAOImpl() {
		super();
	}
