...
@Repository("bsc.dao.StrategyMapDAO")
@Scope("prototype")
public class StrategyMapDAOImpl extends BaseDAO<BbStrategyMap, String> implements IStrategyMapDAO<BbStrategyMap, String> {
	
	public StrategyMapDAOImpl() {
		super();
	}
