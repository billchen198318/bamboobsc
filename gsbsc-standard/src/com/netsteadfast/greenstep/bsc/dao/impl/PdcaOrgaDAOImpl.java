...
@Repository("bsc.dao.PdcaOrgaDAO")
@Scope("prototype")
public class PdcaOrgaDAOImpl extends BaseDAO<BbPdcaOrga, String> implements IPdcaOrgaDAO<BbPdcaOrga, String> {
	
	public PdcaOrgaDAOImpl() {
		super();
	}
