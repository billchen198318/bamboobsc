...
@Repository("bsc.dao.WorkspaceTemplateDAO")
@Scope("prototype")
public class WorkspaceTemplateDAOImpl extends BaseDAO<BbWorkspaceTemplate, String> implements IWorkspaceTemplateDAO<BbWorkspaceTemplate, String> {
	
	public WorkspaceTemplateDAOImpl() {
		super();
	}
