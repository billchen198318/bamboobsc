...
@Repository("bsc.dao.PdcaMeasureFreqDAO")
@Scope("prototype")
public class PdcaMeasureFreqDAOImpl extends BaseDAO<BbPdcaMeasureFreq, String> implements IPdcaMeasureFreqDAO<BbPdcaMeasureFreq, String> {
	
	public PdcaMeasureFreqDAOImpl() {
		super();
	}
