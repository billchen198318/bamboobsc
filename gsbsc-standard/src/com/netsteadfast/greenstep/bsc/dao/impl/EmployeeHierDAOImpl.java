...
@Repository("bsc.dao.EmployeeHierDAO")
@Scope("prototype")
public class EmployeeHierDAOImpl extends BaseDAO<BbEmployeeHier, String> implements IEmployeeHierDAO<BbEmployeeHier, String> {
	
	public EmployeeHierDAOImpl() {
		super();
	}
