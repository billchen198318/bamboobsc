...
@Repository("bsc.dao.OrganizationParDAO")
public class OrganizationParDAOImpl extends BaseDAO<BbOrganizationPar, String> implements IOrganizationParDAO<BbOrganizationPar, String> {
	
	public OrganizationParDAOImpl() {
		super();
	}
