...
@Repository("bsc.dao.SwotReportMstDAO")
@Scope("prototype")
public class SwotReportMstDAOImpl extends BaseDAO<BbSwotReportMst, String> implements ISwotReportMstDAO<BbSwotReportMst, String> {
	
	public SwotReportMstDAOImpl() {
		super();
	}
