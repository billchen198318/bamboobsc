...
@Repository("bsc.dao.SwotReportDtlDAO")
@Scope("prototype")
public class SwotReportDtlDAOImpl extends BaseDAO<BbSwotReportDtl, String> implements ISwotReportDtlDAO<BbSwotReportDtl, String> {
	
	public SwotReportDtlDAOImpl() {
		super();
	}
