...
public class PieChartCompoment extends BaseWorkspaceCompoment {
	private static final long serialVersionUID = -7275160358067570158L;
	public static final String COMPOMENT_ID = "COMP_PIE001";
	private static final String TEMPLATE_RESOURCE = "META-INF/resource/compoments/PieChartCompoment.ftl";
	private Map<String, Object> templateParameters = new HashMap<String, Object>();
	
	public PieChartCompoment() {
		super();
	}
