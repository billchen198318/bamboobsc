...
@Table(
		name="bb_pdca_doc", 
		uniqueConstraints = { 
				@UniqueConstraint( columnNames = {"PDCA_OID", "UPLOAD_OID"} ) 
		} 
)
public class BbPdcaDoc extends BaseEntity<String> implements java.io.Serializable {
	private static final long serialVersionUID = -31807576413246676L;
	private String oid;
