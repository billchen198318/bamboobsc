	...
	<table border="0" width="100%" height="530px" cellpadding="1" cellspacing="0" >	
		<tr>
    		<td height="50px" width="100%"  align="left">
    			<gs:label text="${action.getText('QCHARTS_PROG001D0001A_driverOid')}" id="QCHARTS_PROG001D0001A_driverOid" requiredFlag="Y"></gs:label>
    			<gs:inputfieldNoticeMsgLabel id="QCHARTS_PROG001D0001A_driverOid"></gs:inputfieldNoticeMsgLabel>
    			<br/>
		...
		<tr>
    		<td height="50px" width="100%"  align="left">
    			<gs:label text="${action.getText('QCHARTS_PROG001D0001A_id')}" id="QCHARTS_PROG001D0001A_id" requiredFlag="Y"></gs:label>
    			<gs:inputfieldNoticeMsgLabel id="QCHARTS_PROG001D0001A_id"></gs:inputfieldNoticeMsgLabel>
    			<br/>
		...
		<tr>
    		<td height="50px" width="100%"  align="left">
    			<gs:label text="${action.getText('QCHARTS_PROG001D0001A_name')}" id="QCHARTS_PROG001D0001A_name" requiredFlag="Y"></gs:label>
    			<gs:inputfieldNoticeMsgLabel id="QCHARTS_PROG001D0001A_name"></gs:inputfieldNoticeMsgLabel>
    			<br/>
   		...
   		<tr>
    		<td height="80px" width="100%"  align="left">
    			<gs:label text="${action.getText('QCHARTS_PROG001D0001A_jdbcUrl')}" id="QCHARTS_PROG001D0001A_jdbcUrl" requiredFlag="Y"></gs:label>
    			<gs:inputfieldNoticeMsgLabel id="QCHARTS_PROG001D0001A_jdbcUrl"></gs:inputfieldNoticeMsgLabel>
    			<br/>
 		...
 		<tr>
    		<td height="50px" width="100%"  align="left">
    			<gs:label text="${action.getText('QCHARTS_PROG001D0001A_dbAccount')}" id="QCHARTS_PROG001D0001A_dbAccount" requiredFlag="Y"></gs:label>
    			<gs:inputfieldNoticeMsgLabel id="QCHARTS_PROG001D0001A_dbAccount"></gs:inputfieldNoticeMsgLabel>
    			<br/>
		...
		<tr>
    		<td height="50px" width="100%"  align="left">
    			<gs:label text="${action.getText('QCHARTS_PROG001D0001A_dbPassword')}" id="QCHARTS_PROG001D0001A_dbPassword" requiredFlag="Y"></gs:label>
    			<gs:inputfieldNoticeMsgLabel id="QCHARTS_PROG001D0001A_dbPassword"></gs:inputfieldNoticeMsgLabel>
    			<br/>
		...
		<tr>
		    <td height="150px" width="100%" align="left">
		    	<gs:label text="${action.getText('QCHARTS_PROG001D0001A_description')}" id="QCHARTS_PROG001D0001A_description"></gs:label>
		    	<gs:inputfieldNoticeMsgLabel id="QCHARTS_PROG001D0001A_description"></gs:inputfieldNoticeMsgLabel>
		    	<br/>
