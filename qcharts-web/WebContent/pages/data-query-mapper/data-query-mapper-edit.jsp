	...
	<table border="0" width="100%" height="25px" cellpadding="1" cellspacing="0" >
		<tr>
    		<td height="25px" width="90%"  align="left">
    			<b>Mapper Label</b>:<gs:textBox name="QCHARTS_PROG001D0002E_labelField" id="QCHARTS_PROG001D0002E_labelField" value="" width="200" maxlength="50"></gs:textBox>
    			&nbsp;
    			<b>Mapper Value</b>:<gs:textBox name="QCHARTS_PROG001D0002E_valueField" id="QCHARTS_PROG001D0002E_valueField" value="" width="200" maxlength="50"></gs:textBox>
    			&nbsp;
