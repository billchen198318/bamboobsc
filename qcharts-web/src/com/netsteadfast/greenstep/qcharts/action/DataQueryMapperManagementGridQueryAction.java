...
@Controller("qcharts.web.controller.DataQueryMapperManagementGridQueryAction")
@Scope
public class DataQueryMapperManagementGridQueryAction extends BaseQueryGridJsonAction {
	private static final long serialVersionUID = -8528804036762153942L;
	protected Logger logger=Logger.getLogger(DataQueryMapperManagementGridQueryAction.class);
	private IDataQueryMapperService<DataQueryMapperVO, QcDataQueryMapper, String> dataQueryMapperService;
	private String message = "";
	private String success = IS_NO;
	private List<Map<String, String>> items=new ArrayList<Map<String, String>>();
	
	public DataQueryMapperManagementGridQueryAction() {
		super();
	}
	...
	private void query() throws ControllerException, AuthorityException, ServiceException, Exception {
		QueryResult<List<DataQueryMapperVO>> queryResult = this.dataQueryMapperService.findGridResult(
	...
	private void setGridData(List<DataQueryMapperVO> searchList) throws Exception {
		if (searchList==null || searchList.size()<1) {
			return;
		}		
		this.items = super.transformSearchGridList2JsonDataMapList(searchList, new String[]{"oid", "name", "description"});			
	}
	
	/**
	 * qcharts.dataQueryMapperManagementGridQueryAction.action
	 */
