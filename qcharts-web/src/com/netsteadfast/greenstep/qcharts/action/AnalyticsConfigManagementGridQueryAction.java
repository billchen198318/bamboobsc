...
@Controller("qcharts.web.controller.AnalyticsConfigManagementGridQueryAction")
@Scope
public class AnalyticsConfigManagementGridQueryAction extends BaseQueryGridJsonAction {
	private static final long serialVersionUID = 7406141589151731789L;
	protected Logger logger=Logger.getLogger(AnalyticsConfigManagementGridQueryAction.class);
	private IOlapConfService<OlapConfVO, QcOlapConf, String> olapConfService; 
	private String message = "";
	private String success = IS_NO;
	private List<Map<String, String>> items=new ArrayList<Map<String, String>>();
	
	public AnalyticsConfigManagementGridQueryAction() {
		super();
	}
	...
	private void query() throws ControllerException, AuthorityException, ServiceException, Exception {
		QueryResult<List<OlapConfVO>> queryResult = this.olapConfService.findGridResult(
	...
	private void setGridData(List<OlapConfVO> searchList) throws Exception {
		if (searchList==null || searchList.size()<1) {
			return;
		}		
		this.items = super.transformSearchGridList2JsonDataMapList(
				searchList, new String[]{"oid", "id", "name", "jdbcDrivers", "jdbcUrl"});			
	}
	
	/**
	 * qcharts.analyticsConfigManagementGridQueryAction.action
	 */
