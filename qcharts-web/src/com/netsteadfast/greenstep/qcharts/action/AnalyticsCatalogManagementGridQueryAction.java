...
@Controller("qcharts.web.controller.AnalyticsCatalogManagementGridQueryAction")
@Scope
public class AnalyticsCatalogManagementGridQueryAction extends BaseQueryGridJsonAction {
	private static final long serialVersionUID = -3253115949351376715L;
	protected Logger logger=Logger.getLogger(AnalyticsCatalogManagementGridQueryAction.class);
	private IOlapCatalogService<OlapCatalogVO, QcOlapCatalog, String> olapCatalogService;
	private String message = "";
	private String success = IS_NO;
	private List<Map<String, String>> items=new ArrayList<Map<String, String>>();
	
	public AnalyticsCatalogManagementGridQueryAction() {
		super();
	}
	...
	private void query() throws ControllerException, AuthorityException, ServiceException, Exception {
		QueryResult<List<OlapCatalogVO>> queryResult = this.olapCatalogService.findGridResult(
	...
	private void setGridData(List<OlapCatalogVO> searchList) throws Exception {
		if (searchList==null || searchList.size()<1) {
			return;
		}		
		this.items = super.transformSearchGridList2JsonDataMapList(searchList, new String[]{"oid", "id", "name"});			
	}
	
	/**
	 * qcharts.analyticsCatalogManagementGridQueryAction.action
	 */
