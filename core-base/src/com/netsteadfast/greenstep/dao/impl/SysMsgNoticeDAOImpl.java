...
@Repository("core.dao.SysMsgNoticeDAO")
public class SysMsgNoticeDAOImpl extends BaseDAO<TbSysMsgNotice, String> implements ISysMsgNoticeDAO<TbSysMsgNotice, String> {
	
	public SysMsgNoticeDAOImpl() {
		super();
	}
