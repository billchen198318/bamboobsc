...
@Repository("core.dao.SysFormDAO")
@Scope("prototype")
public class SysFormDAOImpl extends BaseDAO<TbSysForm, String> implements ISysFormDAO<TbSysForm, String> {
	
	public SysFormDAOImpl() {
		super();
	}
