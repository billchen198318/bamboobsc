...
@Repository("core.dao.SysFormMethodDAO")
@Scope("prototype")
public class SysFormMethodDAOImpl extends BaseDAO<TbSysFormMethod, String> implements ISysFormMethodDAO<TbSysFormMethod, String> {
	
	public SysFormMethodDAOImpl() {
		super();
	}
