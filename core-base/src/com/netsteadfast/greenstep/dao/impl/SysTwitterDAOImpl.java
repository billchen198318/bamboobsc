...
@Repository("core.dao.SysTwitterDAO")
@Scope("prototype")
public class SysTwitterDAOImpl extends BaseDAO<TbSysTwitter, String> implements ISysTwitterDAO<TbSysTwitter, String> {
	
	public SysTwitterDAOImpl() {
		super();
	}
