...
@Repository("core.dao.SysMultiNameDAO")
@Scope("prototype")
public class SysMultiNameDAOImpl extends BaseDAO<TbSysMultiName, String> implements ISysMultiNameDAO<TbSysMultiName, String> {
	
	public SysMultiNameDAOImpl() {
		super();
	}
