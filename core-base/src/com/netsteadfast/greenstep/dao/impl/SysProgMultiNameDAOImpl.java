...
@Repository("core.dao.SysProgMultiNameDAO")
@Scope("prototype")
public class SysProgMultiNameDAOImpl extends BaseDAO<TbSysProgMultiName, String> implements ISysProgMultiNameDAO<TbSysProgMultiName, String> {
	
	public SysProgMultiNameDAOImpl() {
		super();
	}
