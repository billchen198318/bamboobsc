...
public interface ISystemBeanHelpLogicService {
	...
	DefaultResult<SysBeanHelpExprVO> createExpr(SysBeanHelpExprVO beanHelpExpr, 
			String helpOid, String expressionOid) throws ServiceException, Exception;
	
	DefaultResult<Boolean> deleteExpr(SysBeanHelpExprVO beanHelpExpr) throws ServiceException, Exception;
	
	DefaultResult<SysBeanHelpExprMapVO> createExprMap(
